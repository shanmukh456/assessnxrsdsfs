...
class Assessment extends Component {
  ...
  onClickSummaryButton = id => {
    ...
    const selectedQuestion = assessmentQuestion[selectedQuestionData]

    // Set the selected option to the first option of the question
    const selectedOptionId = selectedQuestion.options[0].optionId
    ...
    this.setState(prevState => ({
      ...
      selectedOption: {
        ...
        [selectedQuestionData]: selectedOptionId,
      },
      // Increment answeredQuestionsCount by one
